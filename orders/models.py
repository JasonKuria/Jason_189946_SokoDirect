...
class Order(models.Model):
    ...
    # Status options used to track the progress of an order from placement
    ...
    # Stores the current processing stage of the order.
    # Every new order starts with the "Pending" status by default.
